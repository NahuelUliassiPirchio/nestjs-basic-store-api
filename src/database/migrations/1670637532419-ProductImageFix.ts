...
export class ProductImageFix1670637532419 implements MigrationInterface {
  name = 'ProductImageFix1670637532419';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "bid_item" ("id" SERIAL NOT NULL, "bid_amount" integer NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "bidId" integer, CONSTRAINT "PK_a47431e0ac83d09c2545adb6f90" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "order_item" ("orderItemId" SERIAL NOT NULL, "quantity" integer NOT NULL, "productId" integer, "orderId" integer, CONSTRAINT "PK_84644a0a548aa24c2591fe51967" PRIMARY KEY ("orderItemId"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "product" ADD "image" character varying NOT NULL`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "bid_item" ADD CONSTRAINT "FK_f09fd3f8cf766db4eaec650c320" FOREIGN KEY ("bidId") REFERENCES "bid"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "bid_item" DROP CONSTRAINT "FK_f09fd3f8cf766db4eaec650c320"`,
    );
